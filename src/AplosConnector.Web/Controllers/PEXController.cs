    ...
    public class PexController : Controller
    {
        ...
        public async Task<ActionResult<PexConnectionDetailModel>> GetPexConnectionDetail(string sessionId, CancellationToken cancellationToken)
        {
            ...
            var connectionDetail = new PexConnectionDetailModel
            {
                ...
                SyncingSetup = mapping.SyncInvoices || mapping.SyncTransactions || mapping.SyncTransfers || mapping.SyncPexFees || mapping.SyncRebates || mapping.SyncFundsToPex || mapping.SyncTaxTagToPex || mapping.SyncReimbursements || mapping.SyncOutstandingBills
            };
