...
namespace AplosConnector.Common.Services.Abstractions
{
    public interface IAplosIntegrationService
    {
        ...
        Task<List<AplosApiPayableDetail>> GetAplosPayables(Pex2AplosMappingModel mapping, DateOnly rangeStart, CancellationToken cancellationToken);
        Task<List<AplosOutstandingBillModel>> GetAplosOutstandingBills(Pex2AplosMappingModel mapping, DateTime startDate, CancellationToken cancellationToken);
    }
}